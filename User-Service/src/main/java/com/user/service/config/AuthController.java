 ...
 * 
 * import com.user.service.jwt.model.JwtRequest; import
 * com.user.service.jwt.model.JwtResponse; import
 * com.user.service.security.JwtHelper;
 * 
 * @RestController
 * 
 ...
 * JwtResponse.builder().jwtToken(token).username(userDetails.getUsername()).
